...
// specified metadata.
func (ipc *IPCache) UpsertMetadata(prefix string, src source.Source, resource types.ResourceID, aux ...IPMetadata) {
	ipc.metadata.Lock()
...
func (ipc *IPCache) RemoveMetadata(prefix string, resource ipcacheTypes.ResourceID, aux ...IPMetadata) {
	ipc.metadata.Lock()
...
func (ipc *IPCache) UpsertLabels(prefix string, lbls labels.Labels, src source.Source, resource types.ResourceID) {
	ipc.UpsertMetadata(prefix, src, resource, lbls)
}

func (ipc *IPCache) RemoveLabels(cidr string, lbls labels.Labels, resource types.ResourceID) {
